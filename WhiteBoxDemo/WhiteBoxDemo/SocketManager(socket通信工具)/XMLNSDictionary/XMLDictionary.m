                      ...
                      isFirstElement:(BOOL) isFirstElement
{
    ...
    for(NSUInteger i = 0; i < [arr count]; i++)
    {
        ...
        else if([nodeValue isKindOfClass:[NSDictionary class]] && [nodeName isEqualToString:@"MSG_BODY"])
        {
            [xml appendString:[self convertDictionaryToXML:nodeValue keys:bodyKeys withStartElement:nodeName isFirstElement:NO]];
        }
        else if([nodeValue isKindOfClass:[NSDictionary class]])
        {
            [xml appendString:[self convertDictionaryToXML:nodeValue withStartElement:nodeName isFirstElement:NO]];
