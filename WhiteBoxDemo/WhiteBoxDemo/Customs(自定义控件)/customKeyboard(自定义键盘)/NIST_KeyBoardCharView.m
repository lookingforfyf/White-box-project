...
@interface NIST_KeyBoardCharView ()
{
    float space_x;       /* 按钮竖间距 */
    float space_y;       /* 按钮行间距 */
...
@property (nonatomic, copy) NSArray       * charCollections;       /* 字符按钮 */
@property (nonatomic, strong) UIButton    * shiftButton;           /* 切换大小写 */
@property (nonatomic, strong) UIButton    * delButton;             /*  删除 */
@property (nonatomic, strong) UIButton    * switch123Button;       /* 切换数字 */
@property (nonatomic, strong) UIButton    * switchSymbolButton;    /* 切换字符 */
@property (nonatomic, strong) UIButton    * spaceButton;           /* 空格 */
@property (nonatomic, assign) BOOL          isLow;                 /* 当前是否是小写字母 */
@property (nonatomic, strong) UIImageView * imageViewButton;       /* 高亮按钮 */

@end

@implementation NIST_KeyBoardCharView
