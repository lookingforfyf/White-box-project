...
@interface NIST_KeyBoardSymbolView ()

@property (nonatomic, strong) NSArray     * charCollections;
@property (nonatomic, strong) UIButton    * delButton;          /* 删除 */
@property (nonatomic, strong) UIButton    * switch123Button;    /* 切换数字  */
@property (nonatomic, strong) UIButton    * switchABCButton;    /* 切换字母 */
@property (nonatomic, strong) UIImageView * imageViewButton;    /* 高亮按钮 */

@end

@implementation NIST_KeyBoardSymbolView
