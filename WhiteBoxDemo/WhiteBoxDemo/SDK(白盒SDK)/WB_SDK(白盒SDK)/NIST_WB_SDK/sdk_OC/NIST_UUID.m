...
NSString * const NIST_UUIDsOfUserDevicesDidChangeNotification = @"NIST_UUIDsOfUserDevicesDidChangeNotification";
NSString * const _uuidForInstallationKey =                      @"nist_uuidForInstallation";
NSString * const _uuidForDeviceKey =                            @"nist_uuidForDevice";
NSString * const _uuidsOfUserDevicesKey =                       @"nist_uuidsOfUserDevices";
NSString * const _uuidsOfUserDevicesToggleKey =                 @"nist_uuidsOfUserDevicesToggle";
...
- (void)uuidsOfUserDevices_iCloudChange:(NSNotification *)notification
{
    if( _uuidsOfUserDevices_iCloudAvailable )
    {
        ...
        if([uuidsSet count] > uuidsCount)
        {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:NIST_UUIDsOfUserDevicesDidChangeNotification object:self userInfo:userInfo];
        }
    }
}
